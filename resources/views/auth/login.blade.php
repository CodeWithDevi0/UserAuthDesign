            ...
            <div class="login-container">
                <div class="row align-items-center">
                    <div class="col-md-5 d-none d-md-block text-center text-white">
                        <img src="{{ asset('images/login-illustration.png') }}" alt="Login Illustration" class="img-fluid" style="max-height: 400px; filter: drop-shadow(0 0 10px rgba(103, 58, 183, 0.3));">
                    </div>
